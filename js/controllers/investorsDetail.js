...
soiControllers.controller('investorsDetailController', ['util', '$scope', '$rootScope', '$state', '$stateParams','panelFieldsService','modelService', 'remoteDataService',
  function (util, $scope, $rootScope, $state, $stateParams, panelFieldsService, modelService, remoteDataService) {
    ...
    $scope.update = function() {
      util.navigate('panelItem', {panelName : 'vInvestmentFirmList', recordItemId: $scope.recordItemId, mode: 'viewDetails' })
    }
